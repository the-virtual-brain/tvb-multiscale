...
setuptools.setup(name='tvb-multiscale',
                 ...
                 description='A package for multiscale simulations with TVB and NEST, ANNarchy and NETPYNE (NEURON).',
                 license="GPL v3",
                 author="Dionysios Perdikis, Valeryi Bragin, Lia Domide, TVB Team",
