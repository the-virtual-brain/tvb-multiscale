...
#include "iaf_cond_ww_decomodule.h"
...
iaf_cond_ww_decomodule iaf_cond_ww_decomodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

iaf_cond_ww_decomodule::iaf_cond_ww_decomodule()
{
#ifdef LINKED_MODULE
...
const std::string
iaf_cond_ww_decomodule::name(void) const
{
  return std::string("iaf_cond_ww_decomodule"); // Return name of the module
}

const std::string
iaf_cond_ww_decomodule::commandstring( void ) const
{
  // Instruct the interpreter to load iaf_cond_ww_decomodule-init.sli
  return std::string( "(iaf_cond_ww_decomodule-init) run" );
}

//-------------------------------------------------------------------------------------
void
iaf_cond_ww_decomodule::init( SLIInterpreter* i )
{
  
    nest::kernel().model_manager.register_node_model<nest::iaf_cond_ww_deco>("iaf_cond_ww_deco");
  
} // iaf_cond_ww_decomodule::init()