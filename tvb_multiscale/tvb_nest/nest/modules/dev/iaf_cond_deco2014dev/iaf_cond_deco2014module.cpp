...
#include "iaf_cond_deco2014module.h"
...
iaf_cond_deco2014module iaf_cond_deco2014module_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

iaf_cond_deco2014module::iaf_cond_deco2014module()
{
#ifdef LINKED_MODULE
...
const std::string
iaf_cond_deco2014module::name(void) const
{
  return std::string("iaf_cond_deco2014module"); // Return name of the module
}

const std::string
iaf_cond_deco2014module::commandstring( void ) const
{
  // Instruct the interpreter to load iaf_cond_deco2014module-init.sli
  return std::string( "(iaf_cond_deco2014module-init) run" );
}
