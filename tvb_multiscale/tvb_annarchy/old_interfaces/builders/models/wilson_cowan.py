...
from tvb_multiscale.tvb_annarchy.old_interfaces.builders.models.default import DefaultInterfaceBuilder
from tvb_multiscale.tvb_annarchy.old_interfaces.models import WilsonCowan
