...
Izhikevich_Hamker_Proxy_E = Neuron(
name="Izhikevich_Hamker_Proxy_E",
parameters="""
    a = 0.02
    b = 0.2
    c = -72.0
...
equations="""
    I_syn_ex = - g_ampa*(v-E_ampa)
    I_syn = I_syn_ex - g_base*v + noise * Normal(0.0, 1.0)
    dg_base/dt = -g_base/tau_syn : init = 0
    dv/dt = n2*v*v+n1*v+n0 - u/C  + I + I_syn : init = -70.0
    du/dt = a*(b*(v-Vr)-u) : init = -18.55
""",
...
Izhikevich_Hamker_Proxy_EI = Neuron(
name="Izhikevich_Hamker_Proxy_EI",
parameters="""
    a = 0.02
    b = 0.2
    c = -72.0
...
Izhikevich_Hamker_TVB = Neuron(
name="Izhikevich_Hamker_TVB",
parameters="""
    a = 0.02
    b = 0.2
    c = -72.0
...
""",
equations="""
    I_syn_ex = - (g_ampa+g_ampa_TVB)*(v-E_ampa)
    I_syn_in = - g_gaba*(v-E_gaba)
    I_syn = I_syn_ex + I_syn_in - g_base*v + g_exc + g_dbs + noise * Normal(0.0, 1.0)
    dg_base/dt = -g_base/tau_syn : init = 0
    dg_ampa/dt = -g_ampa/tau_ampa : init = 0
