...
# TODO: check if they stay in their hemisphere in builder

projStr_GPi_Left = ann.Projection(popStr_Left_I1, popGPi_Left_I, 'gaba').connect_all_to_all(weights=1.0, delays=0.05,
                                                                                         allow_self_connections=True,
                                                                                         force_multiple_weights=False)
