...
def transformers_init(config, transformer_interfaces_builder=TVBspikeNetRemoteTransformerBuilder):
...
def tvb_to_spikeNet_transformer_init(config, transformer_interfaces_builder=TVBtoSpikeNetRemoteTransformerBuilder):

    return transformers_init(config, transformer_interfaces_builder)


def spikeNet_to_tvb_transformer_init(config, transformer_interfaces_builder=SpikeNetToTVBRemoteTransformerBuilder):
    return transformers_init(config, transformer_interfaces_builder)
