...
class CoSimulatorParallelNRP(CoSimulatorParallel):
    ...
    tvb_to_spikeNet_interface = None
    spikeNet_to_tvb_interface = None
    ...
    def _run_for_synchronization_time(self, ts, xs, wall_time_start, cosimulation=True, **kwds):
        ...
        if self.simulate_spiking_simulator is not None:
            ...
            if self.tvb_to_spikeNet_interface is not None:
                self.tvb_to_spikeNet_interface()
            ...
            if self.spikeNet_to_tvb_interface is not None:
                self.spikeNet_to_tvb_interface()
