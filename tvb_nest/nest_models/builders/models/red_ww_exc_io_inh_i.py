...
class RedWWExcIOInhIBuilder(DefaultExcIOInhIBuilder):
    ...
    def __init__(self, tvb_simulator, nest_nodes_ids, nest_instance=None, config=CONFIGURED, set_defaults=True,
        ...
        lamda = self.tvb_model.lamda[0].item()
        self.weight_exc = 1.0 / (1 + lamda)
        self.weight_inh = 1 - self.weight_exc
        self.weight_exc *= self.global_coupling_scaling
        self.weight_inh *= self.global_coupling_scaling
