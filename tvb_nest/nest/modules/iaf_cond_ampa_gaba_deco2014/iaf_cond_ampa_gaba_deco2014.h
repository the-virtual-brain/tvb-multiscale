...
*
*  2019-09-27 16:55:18.664965
*/
#ifndef IAF_COND_AMPA_GABA_DECO2014
#define IAF_COND_AMPA_GABA_DECO2014
 ...
 */
extern "C" inline int iaf_cond_ampa_gaba_deco2014_dynamics( double, const double y[], double f[], void* pnode );
...
/* BeginDocumentation
  Name: iaf_cond_ampa_gaba_deco2014.
...
*/
class iaf_cond_ampa_gaba_deco2014 : public nest::Archiving_Node{
public:
  /**
  ...
  */
  iaf_cond_ampa_gaba_deco2014(const iaf_cond_ampa_gaba_deco2014 &);
...
private:
  ...
  friend class nest::RecordablesMap<iaf_cond_ampa_gaba_deco2014>;
  friend class nest::UniversalDataLogger<iaf_cond_ampa_gaba_deco2014>;
  ...
  */
  ...
  /**
    ...
    */
  struct Buffers_ {
    Buffers_(iaf_cond_ampa_gaba_deco2014 &);
    Buffers_(const Buffers_ &, iaf_cond_ampa_gaba_deco2014 &);

    /** Logger for all analog data */
    nest::UniversalDataLogger<iaf_cond_ampa_gaba_deco2014> logger_;
  ...
  */
  ...
  static nest::RecordablesMap<iaf_cond_ampa_gaba_deco2014> recordablesMap_;

  friend int iaf_cond_ampa_gaba_deco2014_dynamics( double, const double y[], double f[], void* pnode );
  
/** @} */
}; /* neuron iaf_cond_ampa_gaba_deco2014 */

inline nest::port iaf_cond_ampa_gaba_deco2014::send_test_event(
...
inline nest::port iaf_cond_ampa_gaba_deco2014::handles_test_event(nest::SpikeEvent&, nest::port receptor_type){
...
inline nest::port iaf_cond_ampa_gaba_deco2014::handles_test_event(
...
inline void iaf_cond_ampa_gaba_deco2014::get_status(DictionaryDatum &__d) const{  
...
inline void iaf_cond_ampa_gaba_deco2014::set_status(const DictionaryDatum &__d){
...
#endif /* #ifndef IAF_COND_AMPA_GABA_DECO2014 */
#endif /* HAVE GSL */