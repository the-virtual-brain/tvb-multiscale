...
#include "tvb_rate_redwongwangmodule.h"
...
/*
 * There are three scenarios, in which tvb_rate_redwongwangmodule can be loaded by NEST:
 *
...
tvbnest::tvb_rate_redwongwangmodule tvb_rate_redwongwangmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

tvbnest::tvb_rate_redwongwangmodule::tvb_rate_redwongwangmodule()
{
#ifdef LINKED_MODULE
...
const std::string
tvbnest::tvb_rate_redwongwangmodule::name( void ) const
{
  return std::string( "My tvb_rate_redwongwangmodule" ); // Return name of the module
}

const std::string
tvbnest::tvb_rate_redwongwangmodule::commandstring( void ) const
{
  // Instruct the interpreter to load tvb_rate_redwongwangmodule-init.sli
  return std::string( "(tvb_rate_redwongwangmodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
tvbnest::tvb_rate_redwongwangmodule::init( SLIInterpreter* i )
{
...
} // tvb_rate_redwongwangmodule::init()
