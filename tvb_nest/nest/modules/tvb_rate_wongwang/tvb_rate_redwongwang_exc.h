...
#ifndef TVB_RATE_REDWONGWANG_EXC_H
#define TVB_RATE_REDWONGWANG_EXC_H
...
/** @BeginDocumentation
Name: tvb_rate_redwongwang_exc - rate model implementing the TVB version of a reduced Wong-Wang model
of an excitatory population .

Description:

tvb_rate_redwongwang_exc is an implementation of a nonlinear rate model with equations:
dS_i/dt = -(1/tau) * S_i + (1-S_i)*g*r_i
 ...
 */
class tvb_rate_redwongwang_exc : public nest::Archiving_Node
{
...
public:
  ...
  tvb_rate_redwongwang_exc( const tvb_rate_redwongwang_exc& );
...
private:
  ...
  friend class nest::RecordablesMap< tvb_rate_redwongwang_exc >;
  friend class nest::UniversalDataLogger< tvb_rate_redwongwang_exc >;
  ...
  struct Buffers_
  {
    Buffers_( tvb_rate_redwongwang_exc& );
    Buffers_( const Buffers_&, tvb_rate_redwongwang_exc& );
    ...
    // is used
    nest::UniversalDataLogger< tvb_rate_redwongwang_exc >
  ...
  static nest::RecordablesMap< tvb_rate_redwongwang_exc > recordablesMap_;
};

inline void
tvb_rate_redwongwang_exc::update( nest::Time const& origin, const long from, const long to )
{
  update_( origin, from, to, false );
}

inline bool
tvb_rate_redwongwang_exc::wfr_update( nest::Time const& origin, const long from, const long to )
{
...
inline nest::port
tvb_rate_redwongwang_exc::handles_test_event(
...
inline void
tvb_rate_redwongwang_exc::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d );
...
inline void
tvb_rate_redwongwang_exc::set_status( const DictionaryDatum& d )
{
