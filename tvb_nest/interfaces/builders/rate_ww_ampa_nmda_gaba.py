...
from tvb_nest.interfaces.rate_ww_ampa_nmda_gaba import RateWWAMPAGABANMDA
...
class RateWWAMPANMDAGABABuilder(TVBNESTInterfaceBuilder):
    ...
    def build_interface(self, tvb_nest_interface=None):
        if not isinstance(tvb_nest_interface, RateWWAMPAGABANMDA):
            tvb_nest_interface = RateWWAMPAGABANMDA()
