...
singularity bash --bind tvb-root/:/home/docker/packages/tvb-root,tvb-multiscale/:/home/docker/packages/tvb-multiscale multi.sif
...
export DOCKER_RUN_FILE=/home/docker/packages/tvb-multiscale/tvb_multiscale/examples/tvb_nest/example.py #here we need to put our python script
