...
DEFAULT_ARGS = {'G': 1.0, 'STIMULUS': 0.1,
                ...
                'output_folder': "", 'verbose': 1, 'plot_flag': False}
...
def configure(**ARGS):
    ...
    # Simulation...
    config.SIMULATION_LENGTH = 2**15 + 1.0  # Testing: 10: 1025, 11: 2049.0, Fitting: 12: 4097.0, BOLD: 16: 65537
    ...
    config.POSTERIOR_SAMPLES_PATH = os.path.join(config.out.FOLDER_RES, "data_samples_fit.pkl")
