...
from tvb_multiscale.tvb_nest.nest_models.models.cereb_no_tvb_nest_builders import CerebBuilder
...
def main_example(tvb_sim_model, nest_model_builder,
    ...
    nodes_inds_to_nodes_labels = {}
    for node_ind in nest_nodes_ids:
        nodes_inds_to_nodes_labels[node_ind] = simulator.connectivity.region_labels[node_ind]

    print(list(zip(nest_nodes_ids, connectivity.region_labels[nest_nodes_ids])))
    ...
    nest_model_builder = CerebBuilder(simulator, nest_instance=nest_instance, config=config, logger=None,
