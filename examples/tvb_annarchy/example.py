...
def main_example(tvb_sim_model, model_params={},
                 ...
                 tvb_spikeNet_interface_builder=DefaultTVBANNarchyInterfaceBuilder(),
    ...
    orchestrator = TVBANNarchySerialOrchestrator(
        config=config,
        logger=logger,
...
def default_example(**kwargs):
    ...
    annarchy_model_builder = DefaultExcIOBuilder
    tvb_annarchy_model_builder = DefaultTVBANNarchyInterfaceBuilder()
